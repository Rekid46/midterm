...
pickle_in = open("decision_midterm.pkl","rb")
model=pickle.load(pickle_in)
dataset= pd.read_csv('Ranjan Singh - Classification Dataset1.csv')
...
def main():
   ...
   <div class="clearfix">           
   <div class="col-md-12">
   <center><p style="font-size:50px;color:black;margin-top:10px;">Poornima Institute of Engineering & Technology</p></center> 
   <center><p style="font-size:40px;color:black;margin-top:10px;">Department of Computer Engineering</p></center> 
   <center><p style="font-size:30px;color:black;margin-top:10px;">Machine Learning Midterm Practical Exam</p></center> 
   </div>
   </div>
   </div>
   """
